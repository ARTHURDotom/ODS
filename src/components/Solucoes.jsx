        ...
        <div className="mt-10 grid gap-8 lg:grid-cols-2">
          <div>
            ...
            <ol className="mt-5 space-y-4">
              {passosDescarte.map((p) => (
                <li
                  key={p.n}
                  className="flex gap-4 rounded-2xl bg-white p-5 lg:p-6 ring-1 ring-white/10 transition-all duration-300 ease-out hover:-translate-y-0.5 hover:shadow-xl hover:ring-lime-300/60"
                >
                  <span
                    aria-hidden="true"
            ...
            <div>
              ...
              <ul className="mt-5 grid gap-4">
                {praticas.map((p) => (
                  <li
                    key={p.titulo}
                    className="rounded-2xl bg-white p-5 lg:p-6 ring-1 ring-white/10 flex gap-3 transition-all duration-300 ease-out hover:-translate-y-0.5 hover:shadow-xl hover:ring-lime-300/60"
                  >
