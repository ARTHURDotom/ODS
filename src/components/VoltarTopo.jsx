...
export default function VoltarTopo() {
  ...
  return (
    <a
      ...
      className={`fixed bottom-5 right-5 z-40 inline-flex h-12 w-12 items-center justify-center rounded-full bg-emerald-600 text-white shadow-xl shadow-emerald-950/30 transition-all duration-300 ease-out hover:-translate-y-1 hover:bg-emerald-500 ${visivel ? 'translate-y-0 opacity-100' : 'pointer-events-none translate-y-4 opacity-0'}`}
    >
